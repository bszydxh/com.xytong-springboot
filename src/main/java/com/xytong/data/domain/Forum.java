...
public class Forum implements Serializable {//面向数据库
    private Integer id;
    ...
    public ForumData toForumDataWithUserData(User user) {
        ...
        forumData.setUserName(user.getName());
        forumData.setUserAvatarUrl(user.getAvatar());
